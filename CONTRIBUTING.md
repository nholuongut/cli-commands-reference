...
The following information provides a set of guidelines for contributing to the nholuongut/cli-commands-reference chain main repo. Use your best judgment, and, if you see room for improvement, please propose changes to this document.

## First steps

The first step is to find an [**issue**](https://github.com/nholuongut/cli-commands-reference/issues) you want to fix. To identify issues we think are good for first-time contributors, we add the **good first issue** label.
...
1. [Fork the repository](https://github.com/nholuongut/cli-commands-reference).
...
8. Next, rinse and repeat the following:
   ...
   git remote add my_new_remote_repo [insert-link-found-in-source-subtab-of-your-repo]

   #Verify new remote

   git remote -v

   > my_new_remote_repo  [link-found-in-source-subtab-of-your-repo] (fetch)
   > my_new_remote_repo  [link-found-in-source-subtab-of-your-repo] (push)

   #Push changes to your remote repo

   git push <your_remote_name>

   #e.g. git push my_new_remote_repo
   ```

   3. Create a PR on the **nholuongut/cli-commands-reference** repository. There should be a PR template to help you do so.
